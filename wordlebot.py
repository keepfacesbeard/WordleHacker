...
def reducePossibles (letter, index):
    removeList=[]
    if index > 0 and index in unknownLetters:
...
def playWordle(answer):
    ...
    # global wordList
    resetAll()
    # print(wordList) #shouldn't need to reset yet is equalling possiblewords
    # possibleWords=wordList
...
## get list of answers from csv
# answerHistory=[]
# csv_file='2022.csv'
# df = pd.read_csv(csv_file)
# answersColumn = df['WORD']
# for item in answersColumn:
#     if type(item) == str and len(item) == 5:
#         answerHistory.append(item.lower())
#     else:
#         continue

# print(answerHistory)
answerHistory=['boost', 'truss', 'siege', 'tiger', 'banal', 'slump', 'crank', 'gorge', 'query', 'drink', 'favor', 'abbey', 'tangy', 'panic', 'solar', 'shire', 'proxy', 'point', 'robot', 'prick', 'wince', 'crimp', 'knoll', 'sugar', 'whack', 'mount', 'perky', 'could', 'wrung', 'light', 'those', 'moist', 'shard', 'pleat', 'aloft', 'skill', 'elder', 'frame', 'humor', 'pause', 'ulcer', 'ultra', 'robin', 'cynic', 'aroma', 'caulk', 'shake', 'dodge', 'swill', 'tacit', 'other', 'thorn', 'trove', 'bloke', 'vivid', 'spill', 'chant', 'choke', 'rupee', 'nasty', 'mourn', 'ahead', 'brine', 'cloth', 'hoard', 'sweet', 'month', 'lapse', 'watch', 'today', 'focus', 'smelt', 'tease', 'cater', 'movie', 'saute']
